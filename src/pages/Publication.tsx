        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-justify text-santaran-charcoal/80 max-w-3xl mx-auto">
              ...
              publications are treasured in esteemed libraries and museums worldwide—including the Library
              of Congress, Asian Art Archive, Nandan Museum, and major academic institutions in
              Bangladesh—serving as vital resources for researchers and enriching the understanding of
              contemporary Bangladeshi art across the globe.            
            </p>
          </div>
