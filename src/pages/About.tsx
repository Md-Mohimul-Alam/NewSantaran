    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative min-h-[70vh] flex items-center justify-center bg-santaran-charcoal">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h1 className={`text-4xl md:text-6xl font-bold text-white mb-6 italic transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <span className="text-santaran-gold">Art for Dignifying Life.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-santaran-charcoal/80 mb-6">
                Founded in 1998, Santaran Art Organization is a nonprofit, multidisciplinary, artist-run collective
                guided by the vision of “Art for Dignifying Life”. Santaran is deeply committed to nurturing
                artistic values that honor indigenous knowledge, celebrate cultural diversity, foster intercultural
                connections, and embrace humane ecology.
                Based in Chittagong, Santaran empowers individuals to engage with art as a transformative force
                enhancing the quality of life and cultivating a vibrant, inclusive community that is rooted in
                Bangladesh yet resonates globally.
              </p>
